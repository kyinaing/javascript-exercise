...
const init = () => {
  ...
  displayScore.classList.add('h1Score')
  displayScore.innerText = `Your Score is: ${score}`;
  document.body.append(displayScore);

  const winnerImg = document.createElement('img')
  const winnerDiv = document.querySelector('.youWin')
  winnerImg.classList.add("winner")
  winnerImg.src = "https://media1.tenor.com/m/-Yf9G_sGZ-8AAAAd/youre-a-winner-winner.gif"
